...
def add_afforestation(n, costs):
    ...
    growth_rate = afforestation_potentials["growth rate [tCO2/ha/y]"].values
    ...
    for potential in potentials:
        if potential == 0:
            ...
            capital_costs.append(cost / growth_rate) # (€/ha) / (tCO2/ha/y)  TODO : check for list of lists (NOTE the cost annualized and the growth rate is also on 1 year basis)
